...
Route::get('new-order', 'CustomerOrderController@index')->name('new-order');
Route::get('cart','ProductController@getCart')->name('cart');
Route::post('place-order', 'CustomerOrderController@store')->name('place-order');
...
// })->name('checkout');
Route::get('product/removeFromCart/{id}','ProductController@removeFromCart')->name('product.removeFromCart');
Route::get('/checkout', 'CustomerOrderController@getCart')->name('checkout');
...
Route::prefix('admin')->group(function () {
    ...
    Route::post('admin-login', 'AdminLoginController@loginAdmin')->name('admin.auth.loginAdmin');
