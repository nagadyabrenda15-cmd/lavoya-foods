    	...
    	<div class="container">
    		...
    		<div class="row">
    			...
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="product">
    					<a href="{{ route('product',['id'=> $product->id]) }}" class="img-prod"><img class="img-fluid" src="{{ asset('images/food/'.$product->image) }}" alt="Product Image">
    					...
    					<div class="text py-3 pb-4 px-3 text-center">
    						...
    						<div class="d-flex">
    							<div class="pricing">
		    						<p class="price"><span class="mr-2 price-dc">Ugx {{ $product->price }}</span><span class="price-sale">Ugx {{ $product->price-40 }}</span></p>
		    					</div>
	    					</div>
