              ...
              <div class="col-lg-8">
                <div class="card-group d-block d-md-flex row">
                  <div class="card col-md-7 p-4 mb-0">
                    <div class="card-body">
                      <h2 style="color: #2eb85c">Admin Login</h2>
                  ...
                  <div class="card col-md-5 text-white bg-primary py-5">
                    <div class="card-body text-center">
                      <div>
                        <h2>Lavoya Foods</h2>
                        <p>Welcome back, admin! Please enter your credentials to access the admin panel.</p>
                        <button class="btn btn-lg btn-outline-light mt-3" type="button">Get Started!</button>
                      </div>
                    </div>
                  </div>
                </div>
