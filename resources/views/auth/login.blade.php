              ...
              <div class="col-lg-8">
                <div class="card-group d-block d-md-flex row">
                  <div class="card col-md-7 p-4 mb-0">
                    <div class="card-body">
                      <h2 style="color: #2eb85c">Customer Login</h2>
                  ...
                  <div class="card col-md-5 text-white bg-primary py-5">
                    <div class="card-body text-center">
                      <div>
                        <h2>Sign up</h2>
                        <p>Welcome to Lavoya Foods Limited! We offer a wide range of delicious and high-quality food products. Join us today and explore our diverse selection of gourmet ingredients and specialty items.</p>
