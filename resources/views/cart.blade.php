...
@section('content')
    ...
    <div class="hero-wrap hero-bread" style="background-image: url('{{ asset('images/food/chiken.jpeg') }}');">
      <div class="container">
	    				...
	    				<table class="table">
						    ...
						    <tbody>
							  ...
							  <tr class="text-center">
								  ...
								  <td class="image-prod"><div class="img" style="background-image:url('{{ asset('images/food/'.$product->image) }}');"></div></td>
								  ...
								  <td class="price">Ugx {{ $product->price }}</td>
								  ...
								  <td class="total">Ugx {{ $product->price }}</td>
							  </tr><!-- END TR-->
							  @endforeach
						    </tbody>
						  </table>
    		...
    		<div class="row justify-content-end">
    			...
    			<div class="col-lg-6 mt-5 cart-wrap ftco-animate">
    				<div class="cart-total mb-3">
    					...
    					<p class="d-flex">
    						<span>Subtotal</span>
    						<span>Ugx {{ $totalPrice }}.00</span>
    					</p>
    					<p class="d-flex">
    						<span>Delivery</span>
    						<span>Ugx {{ \App\BillingInfo::DELIVERY }}.00</span>
    					</p>
						<p class="d-flex">
							<span>Tax</span>
							<span>Ugx {{ \App\BillingInfo::TAX }}.00</span>
						</p>
    					<hr>
    					<p class="d-flex total-price">
    						<span>Total</span>
    						<span>Ugx {{ ($totalPrice+\App\BillingInfo::DELIVERY+\App\BillingInfo::TAX) }}</span>
    					</p>
    				</div>
    				<p>
